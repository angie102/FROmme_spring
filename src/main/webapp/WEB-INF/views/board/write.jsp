		...
		<main role="main">
			...
			<article>
				<div class="board_wrapper board_write_wrapper">
					<form method="post" action="/board/write" name="boardform" enctype="multipart/form-data">
						<input type="hidden" name="category_no" value="${cri.category_no}"/>
						<input type="hidden" name="users_id" value="${session_id}"/>
						<ul class="bbsview_list">
							<li class="bbs_catname"><span>${cri.category_name}</span></li>
							<li class="bbs_title"><input type="text" placeholder="제목을 입력해주세요." name="post_title"></li>
							<li class="bbs_id">작성자 : <span>${session_id}<span></li>
							<textarea id="summernote" class="bbs_content" name="post_content" placeholder="내용을 입력해주세요."></textarea>
							<div class="text_file">
								<h4>파일 첨부</h4>
								<ul>
							...
							<div class="btn_bbs_write">
								<a href="/board/list${cri.getListLink() }" class="btn_bbs">취소</a>
