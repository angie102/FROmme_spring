...
<c:if test="${authority eq 6}">
	<script>
		...
		location.href="/resources/user/UserLogout.use?cat=7";
	</script>
</c:if>
  ...
  <!-- MAIN -->
    ...
    <header>
      <div class="carousel-default owl-carousel carousel-main carousel-nav-white background-dark text-center">
        <div class="item">
          <div class="s-12">
            <img src="/resources/assets/img/header.jpg" alt="">
                ...
                <div class="margin-top-bottom-70">
                  ...
                  <div class="s-12 m-12 l-6 center">
                    ...
                    <div class="margin-bottom-10 background-white-hightlight">
                      <form action="/map/search" name="contactForm" class="customform" method="get">
        ...
        <div class="item">
          <div class="s-12">
            <img src="/resources/assets/img/banner/event_banner2.png" alt="background-dark">
          </div>
        </div>

        <div class="item">
          <div class="s-12">
            <img src="/resources/assets/img/banner/event_banner1.png" alt="background-dark">
          </div>
        </div>
